...
<body>
	...
	<section id="hoe">
		<h1>Club Enrollment and Tracking System<br>
			...
			<button class="button glass"><a href="create-account.php"> Try our sorting hat</a></button>
	...
	<div class="wrapper">
		...
		<div class="container">
			<div class="carousel slide" data-ride="carousel" id="carousel-example-generic">
				...
				<a class="left carousel-control" data-slide="prev" href="#carousel-example-generic" role="button"><span
						aria-hidden="true" class="glyphicon glyphicon-chevron-left"></span> <span
						class="sr-only">Previous</span></a> <a class="right carousel-control" data-slide="next"
					href="#carousel-example-generic" role="button"><span aria-hidden="true"
	...
	<div class="wrapper">
		...
		<div class="container">
			<div class="carousel slide" data-ride="carousel" id="carousel-example-generic-1">
				...
				<a class="left carousel-control" data-slide="prev" href="#carousel-example-generic-1"
					role="button"><span aria-hidden="true" class="glyphicon glyphicon-chevron-left"></span> <span
						class="sr-only">Previous</span></a> <a class="right carousel-control" data-slide="next"
					href="#carousel-example-generic-1" role="button"><span aria-hidden="true"
						class="glyphicon glyphicon-chevron-right"></span> <span class="sr-only">Next</span></a>
			</div>
		</div>
	</div>
